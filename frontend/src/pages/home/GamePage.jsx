...
const GamePage = ({ onGameRequestUpdate }) => {
    ...
    useEffect(() => {
        const fetchPendingGameRequests = async () => {
            try {
                const response = await fetch(`https://socialty.vercel.app/api/games/pending-requests`, {
                    method: "GET",
                    headers: {
    ...
    const handleSendGameRequest = async (userId) => {
        setLoading(true);
        try {
            const response = await fetch(`https://socialty.vercel.app/api/games/send-request`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${localStorage.getItem("token")}`,
    ...
    const handleAcceptGameRequest = async (requestId) => {
        setLoading(true);
        try {
            const response = await fetch(`https://socialty.vercel.app/api/games/accept-request`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${localStorage.getItem("token")}`,
    ...
    const handleRejectGameRequest = async (requestId) => {
        setLoading(true);
        try {
            const response = await fetch(`https://socialty.vercel.app/api/games/reject-request`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${localStorage.getItem("token")}`,
    ...
    const handleMarkCell = async (number) => {
        ...
        setLoading(true);
        try {
            const response = await fetch(`https://socialty.vercel.app/api/games/mark-cell`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${localStorage.getItem("token")}`,
    ...
    const handleStopGame = async () => {
        ...
        setLoading(true);
        try {
            const response = await fetch(`https://socialty.vercel.app/api/games/stop-game`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${localStorage.getItem("token")}`,
